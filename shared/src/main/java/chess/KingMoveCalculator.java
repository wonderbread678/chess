...
public class KingMoveCalculator extends PieceMoveCalculator{
    ...
    public Collection <ChessMove> kingMoveCalculations(ChessBoard board, ChessGame.TeamColor pieceColor, ChessPosition startPosition, ChessPiece.PieceType promotion){
